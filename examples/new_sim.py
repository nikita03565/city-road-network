...
from city_road_network.algo.simulation import NaiveSimulation, SmarterSimulation
...
def run_smarter_simulation(graph, weight, trip_mat=None, old_paths=None, n=None):
